...
<?php include"includes/user_navigation.php" ; ?>
		...
		<div class="main">
			<div class="wrapper">
				...
				?>
				<h3>Recently Added</h3><small>Available houses</small><span class="badge badge-secondary"><?php echo $house_count ; ?> </span>
...
if ((isset($_GET['lowest_price'])) &&  (isset($_GET['higest_price']))) {

	 $lowest = $_GET['lowest_price'];
	 $hiest = $_GET['higest_price'];
	
}
$query = "SELECT * FROM houses WHERE house_rent between $lowest AND $hiest ";
